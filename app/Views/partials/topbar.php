        ...
        <div class="business-switcher" id="businessSwitcher">
            ...
            <div class="business-dropdown" id="businessDropdown">
                ...
                <div class="business-drop-list">
                    ...
                    <?php endforeach; ?>
                    <?php if (in_array(session('kode_role'), ['superadmin', 'owner'], true)): ?>
                    <div style="border-top: 1px solid var(--border); margin-top: 4px; padding-top: 4px;">
                        <a href="<?= base_url('dashboard/master/bisnis') ?>" class="business-drop-item" style="color: var(--accent); font-weight: 600;">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" width="14" height="14">
                                <line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/>
                            </svg>
                            <span>Kelola & Tambah Bisnis</span>
                        </a>
                    </div>
                    <?php endif; ?>
                </div>
