    ...
    <div class="cp-toolbar">
        ...
        <div class="cp-filters">
            <div style="position:relative;">
                ...
                <input type="text" id="searchQuery" class="cp-inp" style="width:230px; padding:8px 12px 8px 34px; font-size:12.5px; border-radius:10px; border:1px solid #cbd5e1; outline:none;" placeholder="Cari tugas desain..." oninput="renderIdeList()">
            </div>
        </div>
    </div>
        ...
        <table class="cp-table">
            <thead>
                <tr>
                    ...
                    <th style="width:18%;">Status Tugas</th>
